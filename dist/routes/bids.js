...
import { listBidsQuerySchema } from '../validators/auction.js';
 ...
 * Auth: bidder only
 */
router.get('/my', requireAuth, requireRole('bidder', 'admin'), validate(listBidsQuerySchema), async (req, res, next) => {
    try {
